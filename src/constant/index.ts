...
export const ALIAS_ADDRESS = {
  ...
  // YOUR CUSTOM POOLS - use POOLS from marisselleHub
  [POOLS.WETH_ETH]: '⚡ WETH/ETH Gas Pool',
  [POOLS.USDC_BASE]: '💵 USDC/BASE Pool',
  [POOLS.BTC_USD_USDC]: '₿ BTC.USD/USDC Pool',
  [POOLS.USDbC_USDC]: '🪙 USDbC/USDC Pool',
  [POOLS.USDbC_ETH]: '🔄 USDbC/ETH Pool',
  [TOKENS.M_ETH]: '⛏️ M_ETH (Mining Token)',
